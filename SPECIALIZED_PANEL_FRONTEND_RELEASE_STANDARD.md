# NikaS Specialized Panel Frontend Delivery Standard v1.9

**Status:** required for every integration-owned Home Assistant specialized panel
**UI authority:** [`NIKAS_SPECIALIZED_PANEL_UI_STANDARD.md`](NIKAS_SPECIALIZED_PANEL_UI_STANDARD.md) v1.9 and [`NIKAS_PANEL_NAVIGATION_CONTRACT.md`](docs/NIKAS_PANEL_NAVIGATION_CONTRACT.md)
...
The production bundle must implement the v1.9 application shell:
...
- optional connection/freshness indicator only when explicitly requested, using the canonical v1.9 vocabulary and status-tinted plaque;
