...
**UI authority:** [`NIKAS_SPECIALIZED_PANEL_UI_STANDARD.md`](NIKAS_SPECIALIZED_PANEL_UI_STANDARD.md) v1.8 and [`NIKAS_PANEL_NAVIGATION_CONTRACT.md`](docs/NIKAS_PANEL_NAVIGATION_CONTRACT.md)
...
The production bundle must implement the v1.8 application shell:
...
- optional connection/freshness indicator only when explicitly requested, using the canonical v1.8 vocabulary and status-tinted plaque;
